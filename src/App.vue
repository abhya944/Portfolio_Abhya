...
import Resume from "./features/resume/components/Resume.vue";
import { useProjectTransition } from "./composables/useProjectTransition";
import { useScroll } from "./composables/useScroll";
import { isResumeRoute, projectVisible } from "./composables/useRouteObserver";
...
<template>
  ...
  <!-- main page -->
  <div v-if="!isResumeRoute" :class="{ 'home-wrapper-projectIsReady': projectVisible }">
    <Home />
  </div>
  <Resume v-else />
