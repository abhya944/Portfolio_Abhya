...
import { isResumeRoute, projectId } from "../composables/useRouteObserver";
...
const isSubPage = computed(() => projectId.value !== null || isResumeRoute.value);
...
const getInTouchClassNames = computed(() => {
  return {
    ...
    "header-get-in-touch-isProjectPage": isSubPage.value,
  };
});
</script>
  ...
  <header :class="classNames">
    <div class="header-left">
      <ButtonRound
        ...
        :class="{ 'header-back': true, 'header-back-isProjectPage': isSubPage }"
    ...
    <div
      :class="{
        ...
        'header-logo-clickable': scrolledPastHeroVisible || isResumeRoute,
