...
type ActiveLink = "about" | "projects" | "contact" | "resume";
const activeLink = ref<ActiveLink | null>(null);
const sections: ActiveLink[] = ["about", "projects", "contact", "resume"];
const ariaLabels = {
  about: t("about"),
  projects: t("projects"),
  contact: t("contact"),
  ...
  <div :class="['header-home', { 'header-home-mounted': isMounted, 'header-home-isProjectPage': projectId !== null }]">
    <div :class="['header-home-links', { 'header-home-links-dark': isDarkTheme }]">
      ...
      <HeaderLink
        ...
        @click.stop="handleLinkClick(section === 'resume' ? '/resume' : '#' + section)"
