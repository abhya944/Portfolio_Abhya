    ...
    <div class="preview-card-content">
      <div class="preview-card-copys">
        ...
        <div class="preview-card-stack">
          <p class="preview-card-stack-label">Tech stack</p>
          <div class="preview-card-stack-items">
            <span class="preview-card-stack-item" v-for="item in props.preview.stack" :key="item">{{ item }}</span>
          </div>
        </div>
        <p class="preview-card-summary">{{ props.preview.summary }}</p>
      </div>
    </div>
  </Link>
