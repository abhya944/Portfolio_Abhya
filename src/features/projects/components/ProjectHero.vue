...
<template>
  <div class="project-hero grid">
    ...
    <div class="project-hero-buttons">
      ...
      >
        <Button renderAs="div" variant="accent" class="project-hero-action children-unclickable" data-hoversound="hover">
          <Github class="project-hero-action-icon" />
          {{ t("view-code") }}
        </Button>
      </Link>
      <div v-else class="project-hero-button project-hero-button-disabled">
        <Button renderAs="div" variant="accent" class="project-hero-action children-unclickable">
          <Github class="project-hero-action-icon" />
          {{ t("view-code") }}
        </Button>
      </div>
      <Link
        ...
        data-cursor="arrow-external"
      >
        <Button renderAs="div" variant="border" class="project-hero-action children-unclickable" data-hoversound="hover">
          <Medium class="project-hero-action-icon" />
          {{ t("blog") }}
        </Button>
      </Link>
      <div v-else class="project-hero-button project-hero-button-disabled">
        <Button renderAs="div" variant="border" class="project-hero-action children-unclickable">
          <Medium class="project-hero-action-icon" />
          {{ t("blog") }}
        </Button>
      </div>
